        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="<?php echo base_url('poli')?>">Pages</a></li>
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Form Pendaftaran Pasien</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Form Pendaftaran Pasien</h6>
            </nav>
        </div>
                ...
                <div class="card-body">
                    <form>
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="noKTP" class="form-control-label">No.KTP</label>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control reset-form" type="text" id="txalamat" placeholder="Contoh: Jebres, Kec. Jebres, Kota Surakarta, Jawa Tengah">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="txphone" class="form-control-label">No.Telephone</label>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="button" onclick="reset_form()" class="btn btn-danger me-2" data-bs-dismiss="modal">
                                <span>Reset Form</span>
                            </button>
                            <button type="button" onclick="simpan_data()" class="btn btn-success me-2">
