                    ...
                    <div class="card-body p-3 position-relative">
                        <div class="row">
                            <div class="col-8 text-start">
                                ...
                                <h5 class="text-white font-weight-bolder mb-0 mt-3" id="total-pasien">0</h5>
                                <span class="text-white text-sm">Total Pasien</span>
                            </div>
                    ...
                    <div class="card-body p-3 position-relative">
                        <div class="row">
                            <div class="col-8 text-start">
                                ...
                                <h5 class="text-white font-weight-bolder mb-0 mt-3" id="total-umum">0</h5>
                                <span class="text-white text-sm">Antrian Poli Umum</span>
                            </div>
                            <div class="col-4 text-end">
                            </div>
                        </div>
                    ...
                    <div class="card-body p-3 position-relative">
                        <div class="row">
                            <div class="col-8 text-start">
                                ...
                                <h5 class="text-white font-weight-bolder mb-0 mt-3" id="total-gizi">0</h5>
                                <span class="text-white text-sm">Antrian Poli Gizi</span>
                            </div>
                            <div class="col-4 text-end">
                            </div>
                        </div>
            ...
            <div class="col-lg-12 col-md-6 mb-md-0 mb-4">
                <div class="card text-center">
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-12">
                                <h3>Selamat Datang Di Dashboard Pendaftaran</h3>
                                <p class="fs-4 mb-0">RS Hati Mulyana</p>
                            </div>
                        </div>
                    </div>
                </div>
